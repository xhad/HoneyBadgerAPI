...
let appSdkDir = path.join(__dirname,'..','..','client','swagger-api');
...
function createSdk() {
  ...
  return new Promise((resolve, reject) => {
    ...
    let cmd = spawn('swagger-codegen', ['generate', '-i', swaggerDir + '/HoneyBadgerAPI-exported.yml', '-l', 'typescript-angular2', '-o', apiSdkDir]);
